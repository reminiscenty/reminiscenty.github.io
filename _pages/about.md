...
<div style="display: flex; gap: 1em; margin-bottom: 1.5em; align-items: flex-start;">
  <img src="{% if post.header.teaser %}{{ post.header.teaser | prepend: '/images/' | prepend: base_path }}{% else %}{{ '/images/profile.png' | prepend: base_path }}{% endif %}" alt="" style="width: 80px; height: 80px; object-fit: cover; flex-shrink: 0; border-radius: 4px;">
  <div>
